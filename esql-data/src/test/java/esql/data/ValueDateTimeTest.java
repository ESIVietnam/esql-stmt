...
//		assertEquals(valueLocalDateTime.convertTo(Types.TYPE_INT), ValueNumber.buildNumber(Types.TYPE_INT, (((LocalDateTime) valueLocalDateTime.toTemporal()).toEpochSecond(ZoneOffset.of(ZoneId.systemDefault().getId())) * 1000)));
		...
		System.out.println(valueLocalDateTime.convertTo(Types.TYPE_STRING));
		System.out.println(ValueString.buildString(Types.TYPE_STRING, valueLocalDateTime.stringValue()));
