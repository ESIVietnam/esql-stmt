...
public class ConvertValueToObject implements Function<Value, Object> {
    ...
    public Object apply(Value value) {
        ...
        switch (value.getType()) {
            ...
            case TYPE_BYTE:
                return Byte.valueOf( ((ValueNumber)value).byteValue() ); //auto-boxer
            case TYPE_UBYTE:
            case TYPE_SHORT:
                return Short.valueOf( ((ValueNumber)value).shortValue() ); //auto-boxer
            case TYPE_USHORT:
            case TYPE_INT:
                return Integer.valueOf( ((ValueNumber)value).intValue() ); //auto-boxer
            case TYPE_UINT:
            case TYPE_LONG:
                return Long.valueOf( ((ValueNumber)value).longValue() ); //auto-boxer
            case TYPE_ULONG:
                return ((ValueNumber)value).bigIntValue(); //real object
            case TYPE_DECIMAL:
                return ((ValueNumber)value).decimalValue(); //real object
            case TYPE_FLOAT:
                return Float.valueOf( ((ValueNumber)value).floatValue() ); //auto-boxer
            case TYPE_DOUBLE:
                return Double.valueOf( ((ValueNumber)value).doubleValue() ); //auto-boxer
            case TYPE_BOOLEAN:
